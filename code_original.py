...
EAR_THRESHOLD = 0.25
PERCLOS_DURATION = 10  # 15s
PERCLOS_THRESHOLD = 0.3  # 15% eye closure over the period
YAWN_THRESHOLD = 0.7
...
def main(cap: cv2.VideoCapture):
    ...
    frame_duration = 1 / original_fps if original_fps > 0 else 0.03  # Default to 30 FPS if unable to get FPS
